...
class TestCreatives:
    @staticmethod
    @pytest.mark.smoke
    @allure.title('Загрузка креатива в размещении')
    @allure.story(jira.JIRA_LINK + 'MDP-5980')
    @allure.testcase(case.ALLURE_LINK + '346844')
    @allure.severity(allure.severity_level.NORMAL)
    def test_creative_with_image(
        ...
        placement_page.digital_placement.creatives.fill_creative_name(creatives_dictionary['name'])
        placement_page.digital_placement.creatives.fill_creative_naming(creatives_dictionary['naming'])
        ...
        placement_page.digital_placement.creatives.page.get_by_role("checkbox").check()
        placement_page.digital_placement.creatives.click_general_button_confirm()
        placement_page.digital_placement.creatives.page.get_by_text("Добавлен", exact=True).click()
